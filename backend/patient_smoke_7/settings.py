"""
Django settings for patient_smoke_7 project.
...
ROOT_URLCONF = 'patient_smoke_7.urls'
...
WSGI_APPLICATION = 'patient_smoke_7.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_smoke_7 API",
    "DESCRIPTION": "API documentation for patient_smoke_7 App",
    "VERSION": "v1",
}
